...
autocmd BufRead,BufNewFile if empty(&filetype) | ~/.config/* set filetype=config | endif
autocmd BufRead,BufNewFile if empty(&filetype) | ~/dotfiles/*/.config/* set filetype=config | endif
autocmd BufRead,BufNewFile if empty(&filetype) | ~/dotfiles/bash/* set filetype=zsh | endif
autocmd BufRead,BufNewFile if empty(&filetype) | ~/dotfiles/zsh/* set filetype=zsh | endif
