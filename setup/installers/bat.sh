...
BAT_VERSION=0.20.0
wget -nc "https://github.com/sharkdp/bat/releases/download/v$BAT_VERSION/bat-v$BAT_VERSION-x86_64-unknown-linux-gnu.tar.gz"
tar xf "bat-v$BAT_VERSION-x86_64-unknown-linux-gnu.tar.gz"
cd "bat-v$BAT_VERSION-x86_64-unknown-linux-gnu" || exit 1
